	...
	return {
		...
		execute: function () {
			...
			_export("default", function (app, _ref) {
				...
				if ( /*window.location.hostname !== 'localhost' ||*/data.length === 0) return;
				...
				app.on("load", function () {
					...
					try {
						for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
							...
							for (var i in app.data[name]) {
								if (typeof app.data[name][i] === "number") {
									folder.add(app.data[name], i, -app.data[name][i], app.data[name][i] * 3);
								} else if (app.data[name][i][0] === "#" && app.data[name][i].length === 7) {
									folder.addColor(app.data[name], i);
								} else {
									folder.add(app.data[name], i);
								};
							};
						}
					} catch (err) {
			...
			dat.controllers.Controller = (function (e) {
				var a = (function (_a) {
					var _aWrapper = function a(_x, _x2) {
			...
			dat.dom.dom = (function (e) {
				function a(c) {
					if ("0" === c || e.isUndefined(c)) {
						return 0;
					}c = c.match(d);return e.isNull(c) ? 0 : parseFloat(c[1]);
			...
			dat.controllers.OptionController = (function (e, a, b) {
				var d = (function (_d) {
					var _dWrapper = function d(_x, _x2, _x3) {
			...
			dat.controllers.NumberController = (function (e, a) {
				var b = (function (_b) {
					var _bWrapper = function b(_x, _x2, _x3) {
			...
			dat.controllers.NumberControllerSlider = (function (e, a, b, d, f) {
				function c(a, c, d, b, f) {
					...
					var _pWrapper = function p(_x, _x2, _x3, _x4, _x5) {
						return _p.apply(this, arguments);
					};

					_pWrapper.toString = function () {
						return _p.toString();
					};
			...
			dat.GUI = dat.gui.GUI = (function (e, a, b, d, f, c, p, k, l, q, n, r, y, g, h) {
				function t(a, c, b, e) {
					...
					b.__li = d;b.__gui = a;h.extend(b, { options: function options(d) {
							if (1 < arguments.length) {
								return (b.remove(), t(a, b.object, b.property, { before: b.__li.nextElementSibling, factoryArgs: [h.toArray(arguments)] }));
							}if (h.isArray(d) || h.isObject(d)) {
								return (b.remove(), t(a, b.object, b.property, { before: b.__li.nextElementSibling, factoryArgs: [d] }));
							}
					...
					var b = a.getRoot(),
						...
						var e = b.__rememberedObjectIndecesToControllers[c];void 0 === e && (e = {}, b.__rememberedObjectIndecesToControllers[c] = e);e[d.property] = d;if (b.load && b.load.remembered) {
							b = b.load.remembered;if (b[a.preset]) b = b[a.preset];else if (b[z]) b = b[z];else {
								return;
				...
				function B(a, b) {
					...
					g.addClass(this.domElement, "dg");this.__folders = {};this.__controllers = [];this.__rememberedObjects = [];this.__rememberedObjectIndecesToControllers = [];this.__listening = [];a = a || {};a = h.defaults(a, { autoPlace: !0, width: m.DEFAULT_WIDTH });a = h.defaults(a, { resizable: a.autoPlace, hideable: a.autoPlace });h.isUndefined(a.load) ? a.load = { preset: z } : a.preset && (a.load.preset = a.preset);h.isUndefined(a.parent) && a.hideable && I.push(this);a.resizable = h.isUndefined(a.parent) && a.resizable;a.autoPlace && h.isUndefined(a.scrollable) && (a.scrollable = !0);var e = w && "true" === localStorage.getItem(document.location.href + ".isLocal");Object.defineProperties(this, { parent: { get: function get() {
								...
								c.parent ? c.getRoot().preset = b : a.load.preset = b;for (b = 0; b < this.__preset_select.length; b++) this.__preset_select[b].value == this.preset && (this.__preset_select.selectedIndex = b);c.revert();
				...
				function c(a, b, d, c) {
					...
					var _kWrapper = function k(_x, _x2) {
						return _k.apply(this, arguments);
					};

					_kWrapper.toString = function () {
						return _k.toString();
					};
				...
				function f(a, b, d) {
					Object.defineProperty(a, b, { get: function get() {
							...
							}p(this, b, d);return this.__state[b];
						}, set: function set(a) {
